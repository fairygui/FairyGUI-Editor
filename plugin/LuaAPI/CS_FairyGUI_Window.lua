...
---@field public __onInit (fun():void)
---@field public __onShown (fun():void)
---@field public __onHide (fun():void)
---@field public __doShowAnimation (fun():void)
---@field public __doHideAnimation (fun():void)
